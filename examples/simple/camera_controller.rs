...
//     for pointer_input in pointer_inputs.read() {
//         // if pointer_input.button_just_pressed(controller.mouse_key_cursor_grab) {
//         //     info!("Just Pressed");
//         //     *mouse_cursor_grab = true;
//         //     cursor_grab_change = true;
//         // }
//         // if pointer_input.button_just_released(controller.mouse_key_cursor_grab) {
//         //     info!("Just Released");
//         //     *mouse_cursor_grab = false;
//         //     cursor_grab_change = true;
//         // }

//         match pointer_input.action {
//             bevy::picking::pointer::PointerAction::Pressed { direction, button } => {
//                 if pointer_input.button_just_pressed(PointerButton::Primary) {
//                     info!("Just Pressed");
//                     *mouse_cursor_grab = true;
//                     cursor_grab_change = true;
//                 }
...
//                 }
//             }
//             bevy::picking::pointer::PointerAction::Moved { delta } => {
//                 // Accumulate the total amount of
//                 // mouse motion and scroll, from all pending events:
//                 total_motion = total_motion + delta;
//             }
//             // bevy::picking::pointer::PointerAction::Canceled => {}
//             _ => {}
//         }
//     }
...
//     // Handle mouse input
//     if total_motion != Vec2::ZERO && cursor_grab {
//         // Apply look update
//         controller.pitch = (controller.pitch
//             - total_motion.y * RADIANS_PER_DOT * controller.sensitivity)
//             .clamp(-PI / 2., PI / 2.);
//         controller.yaw -= total_motion.x * RADIANS_PER_DOT * controller.sensitivity;
